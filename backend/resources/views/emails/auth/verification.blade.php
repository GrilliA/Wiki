...
@section('content')
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:24px 0;">
        <tr>
            <td align="center" bgcolor="#6741d9" style="background-color:#6741d9;border-radius:6px;">
    ...
    <p style="margin:0 0 16px 0;font-family:'IBM Plex Sans', Arial, sans-serif;font-size:14px;line-height:1.6;color:#71717a;">
        ...
        <a href="{{ $verificationUrl }}" target="_blank" rel="noopener noreferrer" style="color:#6741d9;text-decoration:underline;word-break:break-all;">{{ $verificationUrl }}</a>
    </p>
    <p style="margin:0 0 16px 0;font-family:'IBM Plex Sans', Arial, sans-serif;font-size:16px;line-height:1.6;color:#3f3f46;">
